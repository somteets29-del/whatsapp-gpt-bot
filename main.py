...
Be concise and friendly in your replies. Always 
respond clearly.""",
    max_history_length=15, temperature=0.7, 
    session_timeout=1800, error_message="Sorry, 
    your message could not be processed."
)
# ====== Optional: Enhanced Text Handler ======
...
message_content, messages, session_data):
    user_id = notification.sender content_display = 
    message_content[:100] + "..." if 
    isinstance(message_content, str) and 
    len(message_content) > 100 else message_content 
